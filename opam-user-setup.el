...
;; ## added by OPAM user-setup for emacs / tuareg ## 2fbc0cfae5ce864d5e1454e26e1379e8 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/kyle/.opam/system/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
